                        ...
                        <div class="body-main">
                            <div class="col-md-12 col-xs-18" style="margin: 20px 0px 10px 0px; padding-bottom: 10px;">
    	                        <!--<div class="col-md-1 col-xs-1 tile" style="background-color: #; border: 0px; margin: 0.83%; padding: 38px 10px 5px 5px; text-align: left; font-size: 15px; color: #FFF;"> -->
                                    ...
                                    <h3 style="text-align: center;" style="font: bold;">Daftar Sebagai </h3>
                                    <br>
                                    <br>
                                    <div style="text-align: center;">
                                        <a href="{{ URL::to('/register', ['user' => 'Admin']) }}"><img src="{{ URL::to('/assets/img/setting.png') }}" alt="Admin" height="100px" width="100px" /></a>
                                        <a href="{{ URL::to('/register', ['user' => 'Pimpinan']) }}"><img src="{{ URL::to('/assets/img/male.png') }}" alt="Pmpinan" height="100px" width="100px" style="margin: 0px 50px" /></a>
                                        <a href="{{ URL::to('/register', ['user' => 'Anggota']) }}"><img src="{{ URL::to('/assets/img/people.png') }}" alt="Anggota" height="100px" width="100px" /></a>
                                    </div>
                                    <br>
                                    <div style="text-align: center;">
